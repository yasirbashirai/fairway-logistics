      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <div className="bg-neutral-50 rounded-2xl p-8 sm:p-10 relative">
            ...
            {/* Quote text */}
            <p className="text-dark text-lg leading-relaxed mb-6 animate-fade-in" key={active}>
              &ldquo;{t.text}&rdquo;
            </p>
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <button
              onClick={prev}
              className="w-10 h-10 rounded-full border border-neutral-300 flex items-center justify-center text-neutral-500 hover:border-gold hover:text-gold transition-colors"
